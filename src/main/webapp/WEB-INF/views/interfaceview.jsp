	...
	<section>
		<div class="mainpanel">
			...
			<jsp:include page="common/menu.jsp" flush="true">
				<jsp:param name="nav" value="2" /></jsp:include>
										...
										<div class="pull-right">
											<div class="btn-group mr10">
												<a class="btn btn-sm btn-white tooltips" type="button"
													href="../function/test.do?proID=${project.id}&id=${function.id}"
												...
												<div class="panel panel-default">
														...
														<div class="form-group">
															...
															<div class="col-sm-3">
																<select class="select2" id="method">
																	<option value="GET"
																		${function.method=='GET' ? "selected" :""}>GET</option>
																	<option value="POST"
																		${function.method=='POST' ? "selected" :""}>POST</option>
																	<option value="PUT"
																		${function.method=='PUT' ? "selected" :""}>PUT</option>
																	<option value="DELETE"
																		${function.method=='PUT' ? "selected" :""}>DELETE</option>
																</select>
															</div>
															...
															<div class="col-sm-3">
																<select class="select2" id="response_type">
																	<option value="JSON"
																		${function.method=='JSON' ? "selected" :""}>JSON</option>
																	<option value="XML"
																		${function.method=='XML' ? "selected" :""}>XML</option>
																	<option value="HTML"
																		${function.method=='HTML' ? "selected" :""}>HTML</option>
																	<option value="TEXT"
																		${function.method=='TEXT' ? "selected" :""}>TEXT</option>
																</select>
															</div>
													...
													<div class="col-md-12 mb20">
														...
														<ul class="nav nav-tabs">
															<li class="active"><a href="#returns"
																data-toggle="tab"><strong>返回示例</strong></a></li>
														</ul>
														...
														<div class="tab-content">
															<div class="tab-pane active" id="returns">
																<div class="col-md-12">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<textarea class="form-control" id="response_body"
																				placeholder="示例内容" rows="5">${function.responseBody}</textarea>
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														...
														<button class="btn btn-default" type="button"
															onclick="javascript:window.history.back()">返回</button>
													</div>
													<!-- panel-footer -->
												</div>
												<!-- panel-default -->
...
<script type="text/javascript">
	...
	$(document).on("click", ".module_nav_row", function() {
		window.location.href="../module/interfaces.do?proID="+${project.id};
	});
				...
				success : function(data) {
					/*  data = JSON.parse(data); */
					 if(data.code==1000){
							...
							setTimeout(function(){$("#alert_close").click();}, 1500);
